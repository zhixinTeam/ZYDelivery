...
begin
  ...
  begin
    nStr := 'Select P_ID,P_Type,P_Stock,P_Name From %s';
    ...
    begin
      ...
      while not Eof do
      begin
        nStr := CombinStr([FieldByName('P_Type').AsString,
                FieldByName('P_Stock').AsString,
                '0', '0', '0', '0',
                FieldByName('P_ID').AsString], StockList1.Delimiter);
