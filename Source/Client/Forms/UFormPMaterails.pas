...
begin
  ...
  try
    ...
    FPrefixID := nIni.ReadString(Name, 'IDPrefix', 'GY');
...
procedure TfFormMaterails.EditIDPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
  EditID.Text := FDM.GetSerialID(FPrefixID, sTable_Materails, 'M_ID');
end;
