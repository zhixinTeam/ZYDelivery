...
//  AdjustStringsItem(EditWX.Properties.Items, False);
  ...
  begin
    ...
    with FDM.SqlTemp do
    begin
      BtnYes.Checked := FieldByName('C_Type').AsString <> sFlag_CusZYF;
      BtnNO.Checked  := not BtnYes.Checked;
    end;  
...
begin
  ...
  if BtnYes.Checked then
  begin
    nList.Add(SF('C_Type', sFlag_CusZY));
  end  else

  if BtnNo.Checked then
  begin
    nList.Add(SF('C_Type', sFlag_CusZYF));
  end;  
